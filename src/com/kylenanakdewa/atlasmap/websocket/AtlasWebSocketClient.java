...
public class AtlasWebSocketClient extends PluginWebSocketClient implements Listener {
    ...
    public void sendBlockChange(Block block, BlockChangeType type) {
        ...
        String jsonString = "{type: " + typeString + ", material: " + material + ", world: " + world + ", x: " + x
                + ", y: " + y + ", z: " + z + "}";
    ...
    public void sendChunkBlocks(Chunk chunk) {
        ...
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
                ...
                for (; y > 0 && chunkSnapshot.getBlockEmittedLight(x, y, z)
                        + chunkSnapshot.getBlockSkyLight(x, y, z) > 0; y--) {
                    ...
                    if (material.isBlock() && !material.isAir()) {
                        ...
                        String jsonString = "{type: block_place, material: " + materialString + ", world: " + world
                                + ", x: " + x + ", y: " + y + ", z: " + z + "}";
